...
Buff Me Up is a mobile-first gym tracking SaaS. The current milestone includes Google authentication, protected routing, and a user profile foundation. Workout functionality is deferred.
