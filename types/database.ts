...
type ExerciseRow = { id: string; workout_day_id: string; name: string; sets: number; target_reps: string; default_weight: number | null; exercise_order: number; notes: string | null; created_at: string; updated_at: string };
...
export type Database = {
  public: {
    Tables: {
      ...
      gym_exercises: RelatedTable<ExerciseRow, { id?: string; workout_day_id: string; name: string; sets: number; target_reps: string; default_weight?: number | null; exercise_order: number; notes?: string | null; created_at?: string; updated_at?: string }, Partial<ExerciseRow>, [{ foreignKeyName: "gym_exercises_workout_day_id_fkey"; columns: ["workout_day_id"]; isOneToOne: false; referencedRelation: "gym_workout_days"; referencedColumns: ["id"] }]>;
